  ...
  <nav class="navbar">
    <div class="navbar-inner">
      ...
      <form class="search-form" onsubmit="handleSearch(event)" style="position:relative">
        <input type="search" id="search-input" placeholder="Buscar produtos, marcas e categorias..." autocomplete="off" oninput="buscarSugestoes(this.value, 'search-suggest')">
    ...
    <form class="mobile-search-bar" id="mobile-search-bar" onsubmit="handleSearch(event)" style="position:relative">
      <input type="search" id="mobile-search-input" placeholder="Buscar produtos, marcas e categorias..." autocomplete="off" oninput="buscarSugestoes(this.value, 'mobile-search-suggest')">
      <button type="submit">🔍</button>
      ...
      <div class="footer-grid">
        <div>
          ...
          <div style="display:flex;gap:12px;margin-top:16px">
            <a href="https://www.instagram.com/zipshopsm?igsh=bWhwMG1haTZpYzdn" target="_blank"
            ...
            <a href="https://wa.me/5555981159575" target="_blank"
        ...
        <div>
          ...
          <div class="footer-links">
            ...
            <a href="https://wa.me/5555984566918" target="_blank">Trocas e Devoluções</a>
          </div>
        </div>
        <div>
          <p class="footer-col-title">Suporte</p>
          <div class="footer-links">
            <a href="https://wa.me/5555984566918" target="_blank" style="display:flex;align-items:center;gap:6px">
